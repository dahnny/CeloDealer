    ...
    return (
        <Fragment>
            ...
            <section className="rent-step-section pt-120">
                <div className="element-one"><img src={image} alt="make" /></div>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="block-area">
                                ...
                                <div className="block-body">
                                    <ul className="num-list">
                                        <li><span className="num">01</span>Download CeloWallet Extension</li>
                                        <li><span className="num">02</span>Setup your Wallet</li>
                                        <li><span className="num">03</span>Choose a car</li>
                                        <li><span className="num">04</span>Buy/Rent your car</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
